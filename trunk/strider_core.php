...
/* License:
	...
	I would appreciate (but do not require) an attribution that the new 
	script is based upon Strider Core, with URL etc.

	Everything within the "strider_core" folder is considered a 
	part of Strider Core.
...
/* Known Issues:
	...
	* You can't use activate or deactivate hooks, as neither the 
	...
	actual plugin activation/deactivation.  (You can still use the
	"uninstall.php" method.)
*/
